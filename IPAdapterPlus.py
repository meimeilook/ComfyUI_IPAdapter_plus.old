...
NODE_CLASS_MAPPINGS = {
    "old_IPAdapterModelLoader": IPAdapterModelLoader,
    "old_IPAdapterApply": IPAdapterApply,
    "old_IPAdapterTilesMasked": IPAdapterTilesMasked,
    "old_IPAdapterApplyFaceID": IPAdapterApplyFaceID,
    "old_IPAdapterApplyEncoded": IPAdapterApplyEncoded,
    "old_PrepImageForClipVision": PrepImageForClipVision,
    "old_IPAdapterEncoder": IPAdapterEncoder,
    "old_IPAdapterSaveEmbeds": IPAdapterSaveEmbeds,
    "old_IPAdapterLoadEmbeds": IPAdapterLoadEmbeds,
    "old_IPAdapterBatchEmbeds": IPAdapterBatchEmbeds,
    "old_InsightFaceLoader": InsightFaceLoader,
    "old_PrepImageForInsightFace": PrepImageForInsightFace,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "old_IPAdapterModelLoader": "Load IPAdapter Model",
    "old_IPAdapterApply": "Apply IPAdapter",
    "old_IPAdapterTilesMasked": "IPAdapter Masked Tiles (experimental)",
    "old_IPAdapterApplyFaceID": "Apply IPAdapter FaceID",
    "old_IPAdapterApplyEncoded": "Apply IPAdapter from Encoded",
    "old_PrepImageForClipVision": "Prepare Image For Clip Vision",
    "old_IPAdapterEncoder": "Encode IPAdapter Image",
    "old_IPAdapterSaveEmbeds": "Save IPAdapter Embeds",
    "old_IPAdapterLoadEmbeds": "Load IPAdapter Embeds",
    "old_IPAdapterBatchEmbeds": "IPAdapter Batch Embeds",
    "old_InsightFaceLoader": "Load InsightFace",
    "old_PrepImageForInsightFace": "Prepare Image For InsightFace",
}
